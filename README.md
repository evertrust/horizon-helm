...
| `image.tag`                             | Horizon image tag (immutable tags are recommended)                                        | `2.2.2`                 |
...
| `clientCertificateHeader` | Indicates to Horizon in which header the client certificate will be passed. If not set, Horizon will try to guess the best parsing technique, depending on the ingress.type you specified. | `""`                                                                              |
...
| `upgrade.image.tag`          | Horizon image tag (immutable tags are recommended)                                                                                                    | `2.2.2`                 |
| `upgrade.image.pullPolicy`   | Horizon image pull policy                                                                                                                             | `IfNotPresent`          |
| `upgrade.image.pullSecrets`  | Horizon image pull secrets                                                                                                                            | `[]`                    |
| `upgrade.resources.limits`   | The resources limits for the Horizon container                                                                                                        | `{}`                    |
| `upgrade.resources.requests` | The requested resources for the Horizon container                                                                                                     | `{}`                    |
